...
const ACTION_LABELS: Record<string, string> = {
  ...
  'enrollment.joined': '學員自行加入或申請',
  'enrollment.approved': '核准加入申請',
  'enrollment.rejected': '拒絕加入申請',
  'course.enrollment_policy.updated': '更新選課設定',
  'course.learners.exported': '匯出學員名單',
  ...
  'course.asset.uploaded': '上傳課程素材',
  'course.asset.updated': '修改課程素材名稱',
  'course.asset.deleted': '刪除課程素材',
  'knowledge.document.uploaded': '上傳教材',
  'knowledge.document.version_added': '上傳教材新版',
  'knowledge.document.deleted': '刪除教材',
  'knowledge.document.failed': '教材處理失敗',
